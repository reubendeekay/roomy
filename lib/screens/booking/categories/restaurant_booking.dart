...
class RestaurantBooking extends StatefulWidget {
  final PropertyModel property;
  RestaurantBooking({this.property});
  @override
  _RestaurantBookingState createState() => _RestaurantBookingState();
}

class _RestaurantBookingState extends State<RestaurantBooking> {
  int numOfGuests = 0;
  int numOfRooms = 0;
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: _startDate != null
                        ...
                        : Text('Choose start reservation date'),
                  ),
                  Divider(
                    height: 12,
                  ),
                  ...
                  Container(
                    ...
                    child: _startDate != null
                        ...
                        : Text('Choose end of reservation date'),
                  )
                ],
              ),
            ),
          ...
          Container(
              ...
              child: Column(
                  ...
                  children: List.generate(
                      ...
                      (index) => SelectableServiceTile(
                          widget.property.services[index])))),
          const SizedBox(
            height: 5,
          ),
